...
<html lang="{{ config('app.locale') }}">
    ...
    <body @if (core()->getCurrentLocale() && core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
        ...
        <div id="app">
            ...
            <div class="top_nav_mobile_version">
                ...
                <span class="dt2cl click_to_logou_open top_periosd_click top_nav_mobile_logout">
                    ...
                    <div class="dt2 show_logout_div hide">
                        <ul class="dt2">
                             <li class="dt2" >
                                <a class="dt2"  href="{{ route('shop.home.index') }}" target="_blank">{{ __('vendor::app.layouts.visit-shop') }}</a>
                            </li>
                            <li class="dt2" >
                                <a class="dt2"  href="{{ route('admin.account.edit') }}">{{ __('vendor::app.layouts.my-account') }}</a>
                            </li>
                            <li class="dt2" >
                                <a class="dt2"  href="{{ route('admin.session.destroy') }}">{{ __('vendor::app.layouts.logout') }}</a>
                            </li>
                        </ul>
                    </div>
                </span>
            ...
            @include ('vendor::layouts.nav-top')
            ...
            @include ('vendor::layouts.nav-left')
