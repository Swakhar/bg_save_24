    ...
    <div class="content full-page dashboard">
        <div class="page-header">
            <div class="page-title">
                <h1>{{ __('vendor::app.dashboard.title') }}</h1>
            </div>
        ...
        <div class="page-content">
            ...
            <div class="dashboard-stats">
                ...
                <div class="dashboard-card">
                    <div class="title">
                        {{ __('vendor::app.dashboard.total-customers') }}
                    </div>
                ...
                <div class="dashboard-card">
                    <div class="title">
                        {{ __('vendor::app.dashboard.total-orders') }}
                    </div>
                ...
                <div class="dashboard-card">
                    <div class="title">
                        {{ __('vendor::app.dashboard.total-sale') }}
                    </div>
                ...
                <div class="dashboard-card">
                    <div class="title">
                        {{ __('vendor::app.dashboard.average-sale') }}
                    </div>
                ...
                <div class="right-card-container category">
                    <div class="card">
                        <div class="card-title">
                            {{ __('vendor::app.dashboard.top-performing-categories') }}
                        </div>
                        ...
                        <div class="card-info {{ !count($statistics['top_selling_categories']) ? 'center' : '' }}">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.catalog.categories.edit', $item->category_id) }}">
                                            <div class="description">
                                                ...
                                                <div class="info">
                                                    {{ __('vendor::app.dashboard.product-count', ['count' => $item->total_products]) }}
                                                    &nbsp;.&nbsp;
                                                    {{ __('vendor::app.dashboard.sale-count', ['count' => $item->total_qty_invoiced]) }}
                                                </div>
                                            </div>
                            ...
                            @if (! count($statistics['top_selling_categories']))
                                ...
                                <div class="no-result-found">
                                    ...
                                    <p>{{ __('vendor::app.common.no-result-found') }}</p>
            ...
            <div class="sale-stock">
                <div class="card">
                    <div class="card-title">
                        {{ __('vendor::app.dashboard.top-selling-products') }}
                    </div>
                ...
                <div class="card">
                    <div class="card-title">
                        {{ __('vendor::app.dashboard.customer-with-most-sales') }}
                    </div>
                                ...
                                <li>
                                    ...
                                    @endif
                                        ...
                                        <div class="description">
                                            ...
                                            <div class="info">
                                                {{ __('vendor::app.dashboard.order-count', ['count' => $item->total_orders]) }}
                                                    &nbsp;.&nbsp;
                                                {{ __('vendor::app.dashboard.revenue', [
                ...
                <div class="card">
                    <div class="card-title">
                        {{ __('vendor::app.dashboard.stock-threshold') }}
                    </div>
                                ...
                                <li>
                                    <a href="{{ route('admin.catalog.products.edit', $item->product_id) }}">
                                        ...
                                        <div class="description">
                                            ...
                                            <div class="info">
                                                {{ __('vendor::app.dashboard.qty-left', ['qty' => $item->total_qty]) }}
                                            </div>
                                        </div>
    ...
    <script type="text/x-template" id="date-filter-template">
        <div>
            <div class="control-group date">
                <date @onChange="applyFilter('start', $event)"><input type="text" class="control" id="start_date" value="{{ $startDate->format('Y-m-d') }}" placeholder="{{ __('vendor::app.dashboard.from') }}" v-model="start"/></date>
            </div>

            <div class="control-group date">
                <date @onChange="applyFilter('end', $event)"><input type="text" class="control" id="end_date" value="{{ $endDate->format('Y-m-d') }}" placeholder="{{ __('vendor::app.dashboard.to') }}" v-model="end"/></date>
            </div>
        </div>
    </script>
