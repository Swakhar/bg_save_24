...
class VendorServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer(['vendor::layouts.nav-left', 'vendor::layouts.nav-aside', 'vendor::layouts.tabs'], function ($view) {
            $tree = Tree::create();
        ...
        view()->composer(['vendor::users.roles.create', 'vendor::users.roles.edit'], function ($view) {
            $view->with('acl', $this->createACL());
        });

        view()->composer(['vendor::catalog.products.create'], function ($view) {
            $items = array();
