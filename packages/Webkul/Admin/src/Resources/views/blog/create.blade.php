                    ...
                    <accordian :title="'{{ __('admin::app.catalog.tags.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('headline') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="headline" name="headline" value="{{ old('headline') }}" data-vv-as="&quot;{{ __('admin::app.blog.headline') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('video') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="video" name="video" value="{{ old('video') }}" data-vv-as="&quot;{{ __('admin::app.blog.video') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('image') ? 'has-error' : '']">
                                ...
                                <input type="file" class="form-control-file border" id="image" name="image" value="{{ old('image') }}" data-vv-as="&quot;{{ __('admin::app.blog.image') }}&quot;"/>
