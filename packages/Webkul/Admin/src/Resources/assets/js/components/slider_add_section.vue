...
//            console.log(this.baseUrl)
        ...
        methods: {
            DeleteFromSelect2: function(val) {
                console.log(val)
                // aspect_key_value
                for (let i in this.sliders[val.index].conditions[val.index2].rule_value_multi) {
                    if (this.sliders[val.index].conditions[val.index2].rule_value_multi[i][val.aspect_key_value] == val.val) {
                        this.sliders[val.index].conditions[val.index2].rule_value_multi.splice(i, 1)
                    }
                }
//                this.sliders[val.index].conditions[val.index2].rule_array
            },
            ...
            select2: function (val) {
                console.log(val)
                this.sliders[val.index].conditions[val.index2].rule_value_multi.push(val.val);
            },
            ...
            getAdvertisementData: function (e) {
                let that = this;
                axios.get('/admin/cms/get-slider-add-section')
                    .then(function (response) {
            ...
            select2DeleteItem: function (val) {
//                this[val.v_model]
            },
            ...
            submit : function(){
                ...
                axios.post('/admin/cms/update-slider-add-section', data)
                    .then(data =>{
