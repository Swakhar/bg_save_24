        ...
        @foreach($blogs as $blog)   
            <div class="card">
              ...
              <div class="card-body">
                ...
                <br>
                <div style="max-height: 80px;overflow: hidden;">{!!$blog->description!!}</div>
                <br>
                <a class="btn btn-sm btn-info" href="{{route('shop.about.blog_id',$blog->id)}}">Read More<i class="fa fa-angle-right"></i></a>
              </div>
            </div>
            <br>
            @endforeach
