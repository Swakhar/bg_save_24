...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="padding-bottom: 5px;">
            <center><h1><u>PRIVACY AND CONFIDENTIALITY</u></h1></center>
        </div>
        <div class="col-md-12">
            <p>SafeShop respects the privacy of our users. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website SafeShop.com.bd and our mobile application including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
        ...
        <div class="col-md-12">
            ...
            <p>User information from social networking sites, such as Facebook, Google+, Instagram etc.  including your name, your social network username, location, gender, birth date, email address, profile picture, and public data for contacts, if you connect your account to such social networks. If you are using our mobile application, this information may also include the contact information of anyone you invite to use and join our mobile application.</p>
            ...
            <p>Information from third parties, such as personal information or network friends, if you connect your account to the third party and grant the Site permission to access this information. Once you leave our store’s website or are redirected to a third-party website or application, you are no longer governed by this Privacy Policy or our website’s Terms of Service.</p>
            ...
            <ul class="fa-ul">
                <li><i class="fa fa-angle-double-right"></i>Geo-Location Information. We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our mobile application, to provide location-based services. If you wish to change our access or permissions, you may do so in your device’s settings.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device’s Bluetooth, calendar, camera, contacts, microphone, reminders, sensors, SMS messages, social media accounts, storage and other features. If you wish to change our access or permissions, you may do so in your device’s settings.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Mobile Device Data. We may collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and IP address.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Push Notifications. We may request to send you push notifications regarding your account or the Application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings.</li></br>
            </ul>
        </div>
        <div class="col-md-12">
            ...
            <ul class="fa-ul">
                <li><i class="fa fa-angle-double-right"></i>Administer sweepstakes, promotions, and contests.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Assist law enforcement and respond to subpoena.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Compile anonymous statistical data and analysis for use internally or with third parties.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Create and manage your account.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Deliver targeted advertising, coupons, newsletters, and other information regarding promotions and the Site and our mobile application to you.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Email you regarding your account or order.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Enable user-to-user communications.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Fulfill and manage purchases, orders, payments, and other transactions related to the Site and our mobile application.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Generate a personal profile about you to make future visits to the Site and our mobile application more personalized.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Increase the efficiency and operation of the Site and our mobile application.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Monitor and analyze usage and trends to improve your experience with the Site and our mobile application.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Notify you of updates to the Site and our mobile applications.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Offer new products, services, mobile applications, and/or recommendations to you.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Perform other business activities as needed.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Prevent fraudulent transactions, monitor against theft, and protect against criminal activity.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Process payments and refunds.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Request feedback and contact you about your use of the Site and our mobile application.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Resolve disputes and troubleshoot problems.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Respond to product and customer service requests.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Send you a newsletter.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Solicit support for the Site and our mobile application.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Other.</li></br>
            </ul>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <p>Our tracking technologies are as follows :</p>
        ...
        <div class="col-md-12">
            ...
            <ul class="fa-ul">
                <li><i class="fa fa-angle-double-right"></i>Logging into your account settings and updating your account</li></br>
                <li><i class="fa fa-angle-double-right"></i>Contacting us using the contact information provided below</li></br>
                <li><i class="fa fa-angle-double-right"></i>Others</li></br>
            </ul>
            ...
            <ul class="fa-ul">
                <li><i class="fa fa-angle-double-right"></i>Noting your preferences at the time you register your account with the Site [or our mobile application]</li></br>
                <li><i class="fa fa-angle-double-right"></i>Logging into your account settings and updating your preferences.</li></br>
                <li><i class="fa fa-angle-double-right"></i>Contacting us using the contact information provided below</li></br>
            </ul>
        ...
        <div class="col-md-12">
            ...
            <address style="font-size: 1.5rem;">
                ...
                <i class="fa fa-address-card"></i><strong> Street Address: </strong> Demo<br>
                <i class="fa fa-plane"></i><strong> City: </strong>Demo<br>
                <i class="fa fa-map-marker"></i><strong> State Zip: </strong>Demo<br>
                <i class="fa fa-phone"></i> <abbr title="Phone"> Phone Number:</abbr> Demo<br>
                <i class="fa fa-fax"></i><strong> Fax Number:</strong><a href="mailto:#"> demo</a><br>
                <i class="fa fa-envelope"></i><strong> Email:</strong><a href="mailto:#"> demo</a><br>
            </address>
        </div>
    </div> 
</div>
