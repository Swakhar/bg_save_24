...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset($relative_path . 'themes/velocity/assets/css/velocity.css?version='.$version) }}" />
        ...
        <link rel="stylesheet" href="{{ asset($relative_path . '/themes/velocity/assets/css/custom_design.css') }}" />
